...
const AppContent = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'home':
        return <Feed currentUser={currentUser} onOpenPostModal={handleOpenPostModal} setActiveTab={setActiveTab} setInitialSessionData={setInitialSessionData} />;
      case 'record':
        return <RecordSession currentUser={currentUser} setActiveTab={setActiveTab} initialSessionData={initialSessionData} setInitialSessionData={setInitialSessionData} />;
      case 'todos':
        return <TodoList currentUser={currentUser} isFullPage={true} setActiveTab={setActiveTab} setInitialSessionData={setInitialSessionData} />;
      case 'calendar':
        return <CalendarView currentUser={currentUser} setActiveTab={setActiveTab} setInitialSessionData={setInitialSessionData} />;
      case 'you':
