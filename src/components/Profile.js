...
const Profile = ({ currentUser }) => {
  ...
  useEffect(() => {
    ...
    const userDocRef = doc(db, getUsersPath(), currentUser.uid);
  ...
  if (!profileData)
    return (
      <div className="text-gray-400 p-4 text-center">
        Profile data not available or user not found.
      </div>
    );
        ...
        <div className="flex flex-col sm:flex-row items-center">
          <img
            src={
              ...
              `https://placehold.co/128x128/374151/E5E7EB?text=${
            ...
            onError={(e) => {
              ...
              e.target.src = `https://placehold.co/128x128/374151/E5E7EB?text=${
                profileData.displayName?.charAt(0).toUpperCase() || "U"
              }`;
            }}
          />
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              User ID: <span className="font-mono">{profileData.uid}</span>
            </p>
      ...
      <div className="bg-gray-800 p-4 rounded-lg shadow-md">
        ...
        {userSessions.length === 0 ? (
          <p className="text-gray-400 text-center py-8">
            You haven&apos;t posted any study sessions yet. Go record one!
          </p>
        ) : (
